...
else this.onRefresh()}.bind(this))},initHtml:function(){this.loading=$("<img alt='' src='"+uiBaseURL+"loading.gif'/>");this.calendarUrl=this.getImageUrl("calendar_form");this.cancleUrl=this.getImageUrl("closeForm");this.articleArrowUrl=this.getImageUrl("articleDateArrow");this.articleEmptyUrl=this.getImageUrl("articleEmpty");this.head=$("<div class='head'></div>");this.title2=$("<div class='title2'><img alt='' src='"+this.calendarUrl+"'/><span>"+getLanguage("btnCalendar","\u5f80\u671f")+"</span></div>");
this.close=$("<div class='close'><img alt='' width='auto' height='auto' src='"+this.cancleUrl+"'/><span></span></div>");this.dataButton=$("<div class='dataButton'><img alt='' src='"+this.articleArrowUrl+"'/><input aria-label='"+getLanguage("ariaDatePicker","date picker")+"' id='date-group' placeholder='\u9009\u62e9\u65e5\u671f'/></div>");this.head.append(this.title2);this.head.append(this.dataButton);this.empty=$("<div class='calendar_empty'><img alt='' src='"+this.articleEmptyUrl+"'/><p>\u6ca1\u6709\u76f8\u5173\u7ed3\u679c</p></div>");
this.container=$("<div class='container'></div>");this.head.append(this.close);this.stage.append(this.head);this.stage.append(this.empty);this.stage.append(this.container);$(this.close).changeButtonColor("#333940")},onResize:function(){this.width=windowWidth;this.height=windowHeight;this.stage.css({bottom:-this.height+"px",width:this.width+"px",height:this.height+"px"});this.container.css({width:"100%",height:windowHeight-62+"px",overflow:"auto","scroll-behavior":"smooth",padding:"0"});var f=this.visible?
