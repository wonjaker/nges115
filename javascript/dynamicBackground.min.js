...
Class("LightRainItem",{create:function(a,b){this._super(a,b)},createBody:function(){this.body=$("<img alt='' style='left:0px;top:0px;width:15px;height:24px;position:absolute;z-index:1'></img>");this.body.attr("src",this.getImagePath("raindrop.png"))},initPositions:function(){var a=Number.random(0,this.parent.width),b=Math.floor(this.parent.height+10);this.start=new BackgroundItemPosition(a,-50);this.end=new BackgroundItemPosition(a,b)},refresh:function(){var a=Math.floor($.easing.easeInSine(null,
this.step,this.start.left,this.end.left-this.start.left,this.frameNumber)),b=Math.floor($.easing.easeInSine(null,this.step,this.start.top,this.end.top-this.start.top,this.frameNumber));a=transformCSS({tran:{x:a,y:b}});this.body.css(a)}}).extend("GoThroughItem");Class("HeavyRainAnimation",{create:function(a){this._super(a);this.itemNumber=160;this.frameNumber=20},newItem:function(){return new HeavyRainItem(this.stage,this.frameNumber)}}).extend("AlwaysExistsAnimation");
...
Class("SpaceTravelItem",{create:function(a,b){this._super(a,b)},createBody:function(){this.body=$("<img alt='' style='left:0px;top:0px;width:50px;height:50px;position:absolute;z-index:1;opacity:0.8'></img>");this.body.attr("src",this.getImagePath("star.png"))},initPositions:function(){var a=this.maxOrbit(this.parent.width,this.parent.height),b=Math.floor(.7*a),c=Number.random(0,b);c=$.easing.easeInQuad(null,c,20,b-20,b);fScale=1-.8*c/b;fSpeed=5-4*c/b;this.realFrameNumber=Math.floor(this.frameNumber/
fSpeed);b=Number.random(0,360)/180*Math.PI;var d=this.parent.width/2,e=this.parent.height/2,f=Math.sin(b)*a+d;a=Math.cos(b)*a+e;this.start=new BackgroundItemPosition(Math.sin(b)*c+d,Math.cos(b)*c+e,.1);this.end=new BackgroundItemPosition(f,a,fScale)},maxOrbit:function(a,b){a=Math.max(a,b);return Math.round(Math.sqrt(a*a+a*a))/2},move:function(){this.step++;this.step==this.realFrameNumber&&this.sleep();this.refresh()},refresh:function(){var a=Math.floor($.easing.easeInSine(null,this.step,this.start.left,
this.end.left-this.start.left,this.realFrameNumber)),b=Math.floor($.easing.easeInSine(null,this.step,this.start.top,this.end.top-this.start.top,this.realFrameNumber)),c=$.easing.easeInSine(null,this.step,this.start.scale,this.end.scale-this.start.scale,this.realFrameNumber);a=transformCSS({tran:{x:a,y:b},scale:c});this.body.css(a)}}).extend("GoThroughItem");
Class("MeteorAnimation",{create:function(a){this._super(a);this.itemNumber=3;this.frameNumber=120},newItem:function(){return new MeteorItem(this.stage,this.frameNumber)}}).extend("GoThroughAnimation");
Class("MeteorItem",{create:function(a,b){this._super(a,b)},createBody:function(){this.body=$("<img alt='' style='left:0px;top:-100px;width:2px;height:88px;position:absolute;z-index:1'></img>");this.body.attr("src",this.getImagePath("meteor.png"))},initPositions:function(){var a=Number.random(.5*this.parent.width,1.5*this.parent.width,0),b=Math.PI/180*65,c=Math.floor(this.parent.height+88*Math.cos(b));b=Math.floor(a-c*Math.tan(b));var d=Number.random(.7,1.5,1);this.start=new BackgroundItemPosition(a,
0,d,65);this.end=new BackgroundItemPosition(b,c,d,65)},refresh:function(){var a=Math.floor(this.frameNumber);if(!(this.step>a)){var b=Math.floor($.easing.easeInSine(null,this.step,this.start.left,this.end.left-this.start.left,a)),c=Math.floor($.easing.easeInSine(null,this.step,this.start.top,this.end.top-this.start.top,a));$.easing.easeInSine(null,this.step,1,-1,a);a=transformCSS({origin:{x:0,y:0},tran:{x:b,y:c},rotate:this.start.rotate,scale:this.start.scale});this.body.css(a)}}}).extend("GoThroughItem");
...
Class("SnowItem",{create:function(a,b){this._super(a,b)},createBody:function(){this.body=$("<img alt='' style='left:0px;top:0px;width:22px;height:22px;position:absolute;z-index:1'></img>");this.body.attr("src",this.getImagePath("snow.png"))},initPositions:function(){var a=1.2*this.parent.height,b=Number.random(0,this.parent.width),c=Math.floor(.1*-this.parent.height),d=Number.random(80,100,1),e=Math.PI/180*d;d=Math.floor(b+a*Math.cos(e));a=Math.floor(c+a*Math.sin(e));e=Number.random(.3,1.5);this.start=
new BackgroundItemPosition(b,c,e);this.end=new BackgroundItemPosition(d,a,e)},refresh:function(){var a=this.pointByStep(this.step,this.start.left,this.end.left,this.frameNumber),b=this.pointByStep(this.step,this.start.top,this.end.top,this.frameNumber);a=transformCSS({tran:{x:a,y:b},scale:this.start.scale});this.body.css(a)}}).extend("GoThroughItem");
Class("FireflyAnimation",{create:function(a){this._super(a);this.itemNumber=50;this.frameNumber=300},newItem:function(){return new FireflyItem(this.stage,this.frameNumber)}}).extend("AlwaysExistsAnimation");
Class("FireflyItem",{create:function(a,b){this._super(a,b)},createBody:function(){this.body=$("<img alt='' style='left:0px;top:0px;width:30px;height:30px;position:absolute;z-index:1'></img>");this.body.attr("src",this.getImagePath("firefly.png"))},initPositions:function(){var a=Number.random(0,this.parent.width),b=Number.random(this.parent.height/3,this.parent.height),c=Number.random(.3,1,1);this.start=new BackgroundItemPosition(a,b,c);this.end=null;this.resetTarget()},resetTarget:function(){this.end&&
(this.start=this.end,this.end=null);var a=Number.random(0,35),b=Math.PI/180*a;a=this.start.left+[-1,1][Number.random(.1,1.9,0)]*Math.floor(80*Math.cos(b));a=Number.between(a,-20,this.parentWidth+20);b=this.start.top+[-1,1][Number.random(.1,1.9,0)]*Math.floor(80*Math.sin(b));b=Number.between(b,-20,this.parent.height+20);var c=Number.random(.3,1,1);this.end=new BackgroundItemPosition(a,b,c)},refresh:function(){var a=this.pointByStep(this.step,this.start.left,this.end.left,this.frameNumber);var b=this.pointByStep(this.step,
...
Class("TwinkleItem",{create:function(a,b){this._super(a,b)},createBody:function(){this.body=$("<img alt='' style='left:0px;top:0px;width:26px;height:26px;position:absolute;z-index:1'></img>");this.body.attr("src",this.getImagePath("twinkle.png"))},initPositions:function(){var a=Number.random(0,this.parent.width),b=Number.random(0,this.parent.height),c=Number.random(0,360),d=c+360;this.start=new BackgroundItemPosition(a,b,1,c);this.end=new BackgroundItemPosition(a,b,1,d)},refresh:function(){var a=
this.start.left,b=this.start.top,c=this.pointByStep(this.step,this.start.rotate,this.end.rotate,this.frameNumber,1),d=this.step,e=this.frameNumber/2;d=d<e?this.pointByStep(d,0,1,e,1):this.pointByStep(d-e,1,0,e,1);a=transformCSS({tran:{x:a,y:b},scale:d,rotate:c});this.body.css(a)}}).extend("GoThroughItem");
Class("MoonCloudAnimation",{create:function(a){this._super(a);this.itemNumber=9;this.frameNumber=1800;this.createMoon()},createMoon:function(){this.moon=$("<img alt=''></img>");this.moon.attr("src",this.getImagePath("moon.png"));this.moon.css({position:"absolute",right:"2%",top:"2%"});this.stage.body.append(this.moon)},resize:function(a,b){this._super(a,b);for(a=0;a<this.itemNumber;a++)this.addItem();for(a=0;a<this.itemCount();a++){b=this.getItem(a);var c=this.frameNumber-Math.floor((a+1)*this.frameNumber/
...
Class("BalloonItem",{create:function(a,b,c){this.index=c;this._super(a,b)},createBody:function(){this.body=$("<img alt='' style='left:0px;top:0px;width:150px;height:150px;position:absolute;z-index:1'></img>");this.body.attr("src",this.getImagePath("air_balloon.png"))},initPositions:function(){var a=this.parent.width/1E3,b=Math.floor(125*a),c=Math.floor(140*a);a=0==this.index?Number.random(20,100):this.parent.width-200-Number.random(20,100);c=this.parent.height-b-c;var d=Number.random(30,70),e=c+d;
